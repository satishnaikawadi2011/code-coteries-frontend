...
export const useFeedPostStyles = makeStyles((theme: Theme) => ({
	article:
		{
	...
	postButtons:
		{
			...
			gridGap: 16,
			padding: '6px 0px !important' as any
		},
	postButtonsWrapper:
		{
	...
	textField:
		{
			padding: '10px 0px !important' as any
		},
	root:
		{
	...
	commentContainer:
		{
			...
			padding: '0px 0px 0px 16px !important' as any
		},
	commentButton:
		{
